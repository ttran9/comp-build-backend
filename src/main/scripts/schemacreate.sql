...
create table change_password_token (id bigint not null auto_increment, created_date datetime(6), expiration_date datetime(6), token varchar(255), user_id bigint not null, primary key (id));
...
create table email_verification_token (id bigint not null auto_increment, created_date datetime(6), expiration_date datetime(6), token varchar(255), user_id bigint not null, primary key (id));
