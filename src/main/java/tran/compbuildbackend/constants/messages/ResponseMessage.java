package tran.compbuildbackend.constants.messages;
...
public class ResponseMessage {
    ...
    public static final String PASSWORD_CHANGED = HtmlUtils.htmlEscape("password has been changed! the next time you log in use your new password!");
